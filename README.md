...
- `didakta-{language}-no-links.md` - Markdown without hyperlinks
- `didakta-{language}-no-links-cleaner.md` - Cleaned markdown without links or content table
...
4. **Split Entries**: Access individual concepts from the split-entries folders for focused learning. More coming on that front soon!
